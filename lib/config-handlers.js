...
exports.menu = function(opts,cb) {
	...
	returnMenu.contents[3].value = opts.port;
	returnMenu.contents[4].value = opts.username;
	returnMenu.contents[5].value = opts.password;
	returnMenu.contents[7].value = opts.interval;
