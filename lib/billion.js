...
function Billion(app, opts, action) {
    ...
    process.nextTick(function() {
        setInterval(function() {
			...
			console.log("IP Address: ["+opts.ip_address+"]");
			console.log("Port: ["+opts.port+"]");
			console.log("Page Pointer: ["+opts.page+"]");
			console.log("Pages: ["+opts.pages+"]");
			console.log("Attempting [http://"+opts.username+":"+opts.password+"@"+opts.ip_address+":"+opts.port+"/"+opts.pages[opts.page]+"]");
